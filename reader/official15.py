...
particles = load_sdf(prefix+"ds14_scivis_0128_e4_dt04_0.1500")
...
scale, id, desc_scale, desc_id, num_prog, pid, upid, desc_pid, phantom, \
    ...
    loadtxt(prefix+"rockstar/hlists/hlist_0.15000.list", unpack=True)
...
width =  max(particles['x']) - min(particles['x'])
